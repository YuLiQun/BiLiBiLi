...
//        final View items = rootView.findViewById(R.id.items);
        mListView = (ListView) rootView.findViewById(R.id.items);

        ArrayList<String> arrayList = new ArrayList<String>();
        for (int i = 0; i < 20; i++) {
            arrayList.add("kkkk" + i);
        }
        final LvAdapter adapter = new LvAdapter(arrayList);
...
//                mListView.setOnClickListener(FragmentRevealExample.this);
